...
\end{center}
Crear un directorio en \code{home} llamado ``prueba''
\begin{lstlisting}[basicstyle=\small,xrightmargin=.10\textwidth,xleftmargin=.10\textwidth,language=bash]
$ cd ~
$ mkdir reposlycs
$ cd reposlycs
...
Los archivos se crean con \code{touch} y luego se modifican con el editor de textos:
\begin{lstlisting}[basicstyle=\small,xrightmargin=.10\textwidth,xleftmargin=.10\textwidth,language=bash]
$ touch helloworld.c
...
Para fusionar las ramas se utiliza el comando \code{merge}:
\begin{lstlisting}[basicstyle=\small,xrightmargin=.10\textwidth,xleftmargin=.10\textwidth,language=bash]
$ git merge branchA
...
Desde el directorio \code{home}, se clona el repositorio donde están las prácticas de la asignatura en \LaTeX :
\begin{lstlisting}[basicstyle=\small,xrightmargin=.10\textwidth,xleftmargin=.10\textwidth,language=bash]
$ cd ~ 
